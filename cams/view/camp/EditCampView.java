...
public class EditCampView implements View {
    ...
    public void body() {
        ...
        while (true) {
            ...
            campUtil.displayWithDismiss("Select the field you want to edit.");
            ...
            if (option == campUtil.updateCampOption()) {
                ...
                IntInput confirmOrDiscard = new ConfirmOrDiscardUI("changes");
                if (confirmOrDiscard.getValidInt() != 1) { continue; }
