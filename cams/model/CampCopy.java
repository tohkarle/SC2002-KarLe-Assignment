...
public class CampCopy implements Serializable {
    private int id;
    ...
    public CampCopy(int id, String campName, ArrayList<LocalDate> dates, String faculty, boolean visibility, int staffID, LocalDate registrationClosingDate) {
        // Default values
